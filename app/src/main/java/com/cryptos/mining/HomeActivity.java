...
import com.cryptos.mining.utils.AdminManager;
...
public class HomeActivity extends AppCompatActivity {
            ...
            userRef.child("isBanned").get().addOnCompleteListener(banCheck -> {
                if (banCheck.isSuccessful()) {
                    ...
                    if (isBanned != null && isBanned == 1) {
                        ...
                        // Optional: redirect to login screen or disable UI
                        return;
                    }

                    // 🚫 Not banned, now listen for the rest of the user data
    ...
    private void scheduleAlarm(String uid, String type, long triggerAtMillis, int requestCode) {
        Intent intent = new Intent(this, com.cryptos.mining.receiver.MiningAlarmReceiver.class);
